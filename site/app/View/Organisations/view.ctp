...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Organisation'), array('action' => 'delete', $organisation['Organisation']['id']), array(), __('Are you sure you want to delete # %s?', $organisation['Organisation']['id'])); ?> </li>
